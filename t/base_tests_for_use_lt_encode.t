...
subtest 'XML::Smart::Parser Tests' => sub {
  ...
  my $XML = XML::Smart->new('<a>text1<b>foo</b><c>bar</c>text2</a>' , 'XML::Smart::Parser', 	use_lt_clean => 1 
) ;
...
subtest 'XML::Smart::Parser args test' => sub {
  ...
  my $XML = XML::Smart->new('<root><foo bar="x"/></root>' , 'XML::Smart::Parser', 	use_lt_clean => 1 
) ;
  my $data = $XML->data(noheader => 1) ;
...
subtest 'XML::Smart::Parser nometagen tests' => sub {
  ...
  my $XML = XML::Smart->new($DATA , 'XML::Smart::Parser', 	use_lt_clean => 1 
) ;
...
subtest 'XML::Smart::HTMLParser Tests' => sub {
  ...
  my $XML = XML::Smart->new('<root><foo bar="x"/></root>' , 'XML::Smart::HTMLParser', 	use_lt_clean => 1 
) ;
  my $data = $XML->data(noheader => 1) ;
  $data =~ s/\s//gs ;
  cmp_ok( $data, 'eq', '<root><foobar="x"/></root>' ) ;
...
subtest 'XML::Smart::HTMLParser args Tests' => sub {
  ...
  ` , 'XML::Smart::HTMLParser', 	use_lt_clean => 1 
) ;
...
subtest 'XML::Smart::Parser Tree tests' => sub {
  my $XML0 = XML::Smart->new(q`<root><foo1 name='x'/></root>` , 'XML::Smart::Parser', 	use_lt_clean => 1 
) ;
  my $XML1 = XML::Smart->new(q`<root><foo2 name='y'/></root>` , 'XML::Smart::Parser', 	use_lt_clean => 1 
) ;
...
subtest 'Default Parser Array Test' => sub {
  ...
  my $XML = XML::Smart->new( '', use_lt_clean => 1 ) ;
...
subtest 'XML::Smart::Parser tags Test' => sub {
  ...
  my $XML = XML::Smart->new('<foo port="80">ct<i>a</i><i>b</i></foo>' , 'XML::Smart::Parser', 	use_lt_clean => 1 
) ;
  my $data = $XML->data(noheader => 1) ;
  $data =~ s/\s//gs ;
...
subtest 'XML::Smart::Parser Data populate test' => sub {
  ...
  my $XML = XML::Smart->new('' , 'XML::Smart::Parser',	use_lt_clean => 1 
) ;
...
subtest 'XML::Smart::Parser Data encode test' => sub {
  ...
  $XML = XML::Smart->new($data , 'XML::Smart::Parser', 	use_lt_clean => 1 
) ;
...
subtest 'Default Parser CDATA and Bin data tests' => sub {
  ...
  my $XML = new XML::Smart( '', use_lt_clean => 1 ) ;
...
subtest 'Default Parser cds Tests' => sub {
  ...
  my $xml = XML::Smart->new( '', use_lt_clean => 1 )->{cds} ;
...
subtest 'URL Tests' => sub {
    ...
    my $XML = XML::Smart->new($url , 'XML::Smart::Parser', 	use_lt_clean => 1 
) ;
